...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    precioMayorista: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'nombre'> & Schema.Attribute.Required;
...
export interface ApiSectionsPageSectionsPage extends Struct.SingleTypeSchema {
  collectionName: 'sections_pages';
  info: {
    displayName: 'sections-page';
    pluralName: 'sections-pages';
    singularName: 'sections-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    componente: Schema.Attribute.Component<'banner-hero.hero-principal', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sections-page.sections-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sections-page.sections-page': ApiSectionsPageSectionsPage;
