import { A as AstroError, N as NoImageMetadata, U as UnsupportedImageFormat, z as MissingSharp } from './entrypoint_DMXKRZo6.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality } from './generic_BFqdbm_M.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_H05nQNWL.mjs').then(n => n.i)).default;
  } catch {
