...
import { v as createRenderInstruction, m as maybeRenderHead, o as renderComponent, k as renderTemplate, h as addAttribute, w as renderHead, x as renderSlot } from './entrypoint_DMXKRZo6.mjs';
...
function CartCounter() {
  ...
  return /* @__PURE__ */ React.createElement("span", { className: "cart-count" }, count);
}
...
const AuthStatus = () => {
  ...
  if (loading) {
    return /* @__PURE__ */ React.createElement("div", { style: { width: "150px" } });
  }
  return /* @__PURE__ */ React.createElement("div", { className: "auth-status-container" }, user ? /* @__PURE__ */ React.createElement("details", { className: "user-menu-details" }, /* @__PURE__ */ React.createElement("summary", { className: "user-info-trigger" }, /* @__PURE__ */ React.createElement(User, { size: 22, strokeWidth: 1.5 }), /* @__PURE__ */ React.createElement("span", { className: "user-identifier user-email-text" }, user.displayName || user.email)), /* @__PURE__ */ React.createElement("div", { className: "user-dropdown-menu" }, /* @__PURE__ */ React.createElement("a", { href: "/perfil", className: "dropdown-link" }, "Mi Perfil"), /* @__PURE__ */ React.createElement("button", { onClick: handleSignOut, className: "logout-button" }, "Cerrar Sesión"))) : /* @__PURE__ */ React.createElement("a", { href: "/login", className: "icon-link", "aria-label": "Iniciar Sesión" }, /* @__PURE__ */ React.createElement(User, { size: 22, strokeWidth: 1.5 })));
};

const $$Header = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<header class="site-header" data-astro-cid-3ef6ksr2> <div class="header-top container" data-astro-cid-3ef6ksr2> <button class="mobile-nav-toggle" aria-label="Abrir menú" data-astro-cid-3ef6ksr2> ${renderComponent($$result, "Menu", Menu, { "size": 24, "data-astro-cid-3ef6ksr2": true })} </button> <nav class="nav-left" data-astro-cid-3ef6ksr2> <a href="/" data-astro-cid-3ef6ksr2>Inicio</a> <a href="/nuestro-vivero" data-astro-cid-3ef6ksr2>Nuestro Vivero</a> <a href="/proyectos" data-astro-cid-3ef6ksr2>Proyectos</a> </nav> <div class="logo-container" data-astro-cid-3ef6ksr2> <a href="/" class="logo-text" data-astro-cid-3ef6ksr2> <img src="../images/Logo-esperanza.png" alt="Logo Esperanza Vivero" class="logo-image" width="120" height="57" data-astro-cid-3ef6ksr2> </a> </div> <div class="nav-right" data-astro-cid-3ef6ksr2> ${renderComponent($$result, "AuthStatus", AuthStatus, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/ASUS/Documents/Pruebas-Astro/tienda-esperanza/frontend/src/components/AuthStatus.tsx", "client:component-export": "default", "data-astro-cid-3ef6ksr2": true })} <a href="/carrito" class="icon-link cart-icon-link" aria-label="Carrito" data-astro-cid-3ef6ksr2> ${renderComponent($$result, "ShoppingBag", ShoppingBag, { "size": 22, "strokeWidth": 1.5, "data-astro-cid-3ef6ksr2": true })} ${renderComponent($$result, "CartCounter", CartCounter, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/ASUS/Documents/Pruebas-Astro/tienda-esperanza/frontend/src/components/CartCounter", "client:component-export": "default", "data-astro-cid-3ef6ksr2": true })} </a> </div> </div> <div class="mobile-nav" data-astro-cid-3ef6ksr2> <nav data-astro-cid-3ef6ksr2> <a href="/" data-astro-cid-3ef6ksr2>Inicio</a> <a href="/nuestro-vivero" data-astro-cid-3ef6ksr2>Nuestro Vivero</a> <a href="/proyectos" data-astro-cid-3ef6ksr2>Proyectos</a> </nav> </div> </header> ${renderScript($$result, "C:/Users/ASUS/Documents/Pruebas-Astro/tienda-esperanza/frontend/src/components/Header.astro?astro&type=script&index=0&lang.ts")}`;
...
}, "C:/Users/ASUS/Documents/Pruebas-Astro/tienda-esperanza/node_modules/.pnpm/astro@6.4.8_@types+node@26._288e9d0fd325b6cdfeb54e02229c78b0/node_modules/astro/components/ClientRouter.astro", void 0);
