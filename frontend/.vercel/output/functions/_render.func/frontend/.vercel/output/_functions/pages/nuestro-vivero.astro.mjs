...
import { $ as $$ProjectCarousel } from '../chunks/ProjectCarousel_DhreD6RO.mjs';
import { g as getProjects } from '../chunks/strapi-projects_BqfhrtEH.mjs';
/* empty css                                          */
  ...
  const SAMPLE_PROJECTS = [
    {
      id: 1,
      documentId: "sample-1",
      nombre: "Jard\xEDn Residencial",
      descripcion: "Dise\xF1o y ejecuci\xF3n de jard\xEDn para vivienda privada.",
      activo: true,
      slug: "jardin-residencial",
      imagenes: [{ id: 1, documentId: "img-1", nombre: "Jard\xEDn", alternativeText: "Jard\xEDn de ejemplo", url: "/images/Jardin-1.jpg" }]
    }
  ];
